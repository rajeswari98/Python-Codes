...
for i in range(len(s)):
    if   s[i]=='a': newl.append('aa')
    elif s[i]=='e': newl.append('eee')
    elif s[i]=='i': newl.append('iiii')
    elif s[i]=='o': newl.append('ooooo')
    elif s[i]=='u': newl.append('uuuuuu')

    elif s[i]=='A': newl.append('AA')
    elif s[i]=='E': newl.append('EEE')
    elif s[i]=='I': newl.append('IIII')
    elif s[i]=='O': newl.append('OOOOO')
    elif s[i]=='U': newl.append('UUUUUU')
    else: newl.append(s[i])
